...
/* EXT I2C -- the M5Stack smart keyboard (STM32 @0x6D, STRING mode) lives on the
 * dedicated EXT_I2C bus GPIO0(SDA)/GPIO1(SCL). Repointed from 53/54 (which is the
 * Grove connector) so we actually reach the keyboard. Cost: Grove no longer scanned. */
